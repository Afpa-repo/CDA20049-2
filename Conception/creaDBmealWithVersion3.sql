...
-- Listage des données de la table mealwith.cart : ~4 rows (environ)
...
-- Listage des données de la table mealwith.cart_items : ~10 rows (environ)
/*!40000 ALTER TABLE `cart_items` DISABLE KEYS */;
INSERT INTO `cart_items` (`id`, `id_ingredient_id`, `id_cart_id`, `quantity`, `price_when_bought`) VALUES
	(10, 638, 4, 78, 1.00),
	(11, 640, 4, 32, 2.00),
	(12, 619, 4, 1, 1.00),
	(13, 616, 5, 2, 2.00),
...
-- Listage de la structure de la table mealwith. doctrine_migration_versions
...
-- Listage des données de la table mealwith.doctrine_migration_versions : ~0 rows (environ)
...
-- Listage des données de la table mealwith.ingredients : ~87 rows (environ)
...
-- Listage des données de la table mealwith.ingredient_recipe : ~115 rows (environ)
...
-- Listage des données de la table mealwith.orders : ~4 rows (environ)
/*!40000 ALTER TABLE `orders` DISABLE KEYS */;
INSERT INTO `orders` (`id`, `order_date`, `delivery_address`, `delivery_date`, `cart_id`, `firstname`, `lastname`, `email`) VALUES
	(5, '2020-12-15 08:35:18', 'Pléhédel', NULL, 8, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(6, '2020-12-15 08:40:00', ' 22290 Pléhédel', NULL, 9, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(7, '2020-12-15 08:41:42', ' 22290 Pléhédel', NULL, 10, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(8, '2020-12-15 08:44:45', ' 22290 Pléhédel', NULL, 11, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(9, '2020-12-15 09:46:55', ' 22290 Pléhédel', NULL, 12, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(10, '2020-12-15 09:57:47', ' 22290 Pléhédel', NULL, 13, 'Mathieu', 'Antoine', 'boid@gmail.com'),
	(11, '2020-12-15 10:00:40', ' 22290 Pléhédel', NULL, 14, 'Mathieu', 'Antoine', 'boid@gmail.com');
...
-- Listage des données de la table mealwith.recipes : ~12 rows (environ)
...
-- Listage des données de la table mealwith.users : ~4 rows (environ)
...
INSERT INTO `users` (`id`, `email`, `roles`, `password`, `firstname`, `lastname`, `city`, `address`, `zipcode`) VALUES
	...
	(4, 'boid@gmail.com', '["ROLE_USER"]', '$argon2id$v=19$m=65536,t=4,p=1$d004TGpVbFp6NEVNZDlEVA$2rf+xqTuXdOTVvPqQTphx6qLBEbclmCutuHy7ia8DUk', 'Mathieu', 'Antoine', 'Pléhédel', NULL, 22290);
